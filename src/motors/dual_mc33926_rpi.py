...
def io_init():
    ...
    wiringpi.pinMode(29, wiringpi.GPIO.PWM_OUTPUT)

    wiringpi.pwmSetMode(wiringpi.GPIO.PWM_MODE_MS)
    wiringpi.pwmSetRange(MAX_SPEED)
    wiringpi.pwmSetClock(2)

    wiringpi.pinMode(28, wiringpi.GPIO.OUTPUT)
    ...
    wiringpi.pinMode(4, wiringpi.GPIO.OUTPUT)
    wiringpi.pinMode(5, wiringpi.GPIO.OUTPUT)
    wiringpi.digitalWrite(26, 0) # M2D1
    wiringpi.digitalWrite(27, 1) # M2nD2
    wiringpi.digitalWrite(4, 0) # M1D1
    wiringpi.digitalWrite(5, 1) # M1nD2
